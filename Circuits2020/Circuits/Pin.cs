...
namespace Circuits
{
    ...
    public class Pin
    {
        ...
        private Brush lowVoltgeBrush = Brushes.DarkGray;
        private Brush highVoltageBrush = SystemBrushes.ActiveCaption;
        ...
        public void Draw(Graphics paper)
        {
            ...
            else if (IsInput)
            {
                if(connection != null)
                {
                    if(connection.FromPin.Owner.Evaluate())
                    {
                        brush = highVoltageBrush;
                    }
                    else
